...
Step-by-step gnark circuit setup and generation of keys/proof for the `bn254_verifier` fixture. Run the commands in order.

```sh
cd contracts/bn254_verifier/tests/data/gnark/auxiliary
